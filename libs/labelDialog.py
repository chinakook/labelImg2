...
class LabelDialog(QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, listItem=None):
        ...
        self.extra_edit.editingFinished.connect(self.postProcess2)
    ...
    def postProcess2(self):
        self.extra_edit.setText(self.extra_edit.text())

    def popUp(self, text='', extra_text='', move=True):
        self.edit.setText(text)
        self.extra_edit.setText(extra_text)
